...
public class TMUberDelivery extends TMUberService
{
  ...
  public void setRestaurant(String rs)
  {
    this.restaurant = rs;
  }
  ...
  public void setFoodOrderId(String foodOrdernum)
  {
    this.foodOrderId = foodOrdernum;
  }
  /*
  ...
  public boolean equals(Object other)
  {
    ...
    TMUberService ob=(TMUberService) other;
    if(this.getServiceType().equals(ob.getServiceType())){
      ...
      TMUberDelivery obDelivery=(TMUberDelivery) ob;
      if(this.getRestaurant().equals(obDelivery.getRestaurant()) && this.getFoodOrderId().equals(obDelivery.getFoodOrderId()))
      {
        return true;
      }}
      return false;
