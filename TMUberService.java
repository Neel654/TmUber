...
//removed everything involving driver
abstract public class TMUberService implements Comparable<TMUberService>
{
  ...
  public int compareTo(TMUberService o)
  {
  ...
  {
    // Fill in the code
    //cast the object to a reference of TMUberservice
    TMUberService obj=(TMUberService) other;
    //check the conditions to be equal
    if(this.type.equals(obj.getServiceType()) && this.user.equals(obj.getUser()))
    {
      return true;
    }
    return false;
